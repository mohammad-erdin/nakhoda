			...
			<template v-else-if="column.key === 'actions'">
				...
				>
					<a-popconfirm
						...
						ok-text="Start"
						@confirm="doAction('start', record.id, record.rudderId)"
					>
						<a-button
							type="text"
							title="Start"
							class="px-2 py-1 text-[var(--color-muted)] hover:bg-[rgba(0,0,0,0.04)] hover:text-[var(--color-text)]"
						>
					...
					<a-popconfirm
						...
						ok-text="Stop"
						@confirm="doAction('stop', record.id, record.rudderId)"
					>
						<a-button
							type="text"
							title="Stop"
					...
					<a-popconfirm
						title="Destroy this container?"
						ok-text="Destroy"
						@confirm="doAction('destroy', record.id, record.rudderId)"
					>
						<a-button
							type="text"
							danger
							class="text-[var(--color-danger)] px-2 py-1"
							title="Destroy"
						>
